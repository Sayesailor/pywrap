...
*/
int tcprecvdata_nb(SOCKET sock, void *data, const INT64 size, const int timeout, int *count);
 ...
 *  return: error no, 0 success, != 0 fail
*/
int tcpsenddata_nb(SOCKET sock, void *data, const INT64 size, const int timeout);
 ...
 *  return: error no, 0 success, != 0 fail
*/
int connectserverbyip(SOCKET sock, const char *server_ip, const short server_port);
